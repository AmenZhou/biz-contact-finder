#!/usr/bin/env python3
"""
Enrich accountants with addresses using Serper Google Maps API
"""
...
INPUT_CSV = DATA_DIR / "queens_brooklyn_accountants.csv"
OUTPUT_CSV = DATA_DIR / "queens_brooklyn_accountants_with_addresses.csv"
...
def enrich_with_address(row: pd.Series) -> pd.Series:
    """Enrich an accountant record with address from Google Maps"""
...
def main():
    """Main execution"""
    print("=" * 80)
    print("ENRICHING ACCOUNTANTS WITH ADDRESSES")
    print("=" * 80)
    print()
