...
BUILDINGS_CSV = DATA_DIR / "buildings" / "lower_manhattan_office_buildings.csv"
TENANTS_DIR = DATA_DIR / "tenants" / "lower_manhattan"
OUTPUT_KML = DATA_DIR / "exports" / "lower_manhattan_tenants.kml"
...
def export_to_kmz() -> None:
    ...
    doc_desc.text = f"""Lower Manhattan office buildings with tenant directories
...
Total buildings: 324 | Buildings with data: 132"""
