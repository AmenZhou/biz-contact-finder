#!/usr/bin/env python3
"""
Step 2: District 9 Office Building Tenant Scraper - Web Scraping + OpenAI Only
...
INPUT_CSV = DATA_DIR / "buildings" / "district9_buildings.csv"
TENANTS_DIR = DATA_DIR / "tenants" / "district9"
COVERAGE_REPORT = DATA_DIR / "scraping_coverage_report_district9.csv"
