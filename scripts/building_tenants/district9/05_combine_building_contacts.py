#!/usr/bin/env python3
"""
Combine all District 9 building management contacts into a single CSV file
...
OUTPUT_CSV = DATA_DIR / "exports" / "district9_building_management_contacts.csv"
...
def combine_building_contacts() -> None:
    ...
    print("=" * 60)
    print("COMBINING DISTRICT 9 BUILDING MANAGEMENT CONTACTS")
    print("=" * 60)
