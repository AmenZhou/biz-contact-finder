#!/usr/bin/env python3
"""
Enrich law offices with addresses using Serper Google Maps API
"""
...
OUTPUT_CSV = DATA_DIR / "queens_brooklyn_law_offices_with_addresses.csv"
...
def main():
    """Main execution"""
    print("=" * 80)
    print("ENRICHING LAW OFFICES WITH ADDRESSES")
    print("=" * 80)
    print()
