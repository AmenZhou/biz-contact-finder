#!/usr/bin/env python3
"""
Enrich law offices with ratings and reviews using Serper Google Maps API
"""
...
INPUT_CSV = DATA_DIR / "queens_brooklyn_law_offices_with_addresses_llm.csv"
OUTPUT_CSV = DATA_DIR / "queens_brooklyn_law_offices_final.csv"
...
def enrich_record(row: pd.Series, index: int, total: int) -> pd.Series:
    """Enrich a single law office record with rating and reviews"""
...
def main():
    """Main execution"""
    print("=" * 80)
    print("ENRICHING LAW OFFICES WITH RATINGS AND REVIEWS")
    print("=" * 80)
    print()
